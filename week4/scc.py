...
find the first 5 largest SCC
"""

# some idea comes from https://class.coursera.org/algo-004/forum/thread?thread_id=1135
# "To do and Not to do Python"
import sys
import threading
...
def buildAdjList(file_name):
	...
	for line in input_file:
		...
		# add the adjacent vertex to corresponding index which is the vertex
...
def main():
	...
	graph, graphRversed = buildAdjList('SCC.txt')
